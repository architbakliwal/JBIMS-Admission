...
CREATE TABLE IF NOT EXISTS `added_academic_details` (
  ...
  PRIMARY KEY (`uid`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=8635 ;
...
CREATE TABLE IF NOT EXISTS `added_work_experience_details` (
  ...
  PRIMARY KEY (`uid`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=6674 ;
...
CREATE TABLE IF NOT EXISTS `admission_users` (
  ...
  PRIMARY KEY (`uid`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=17870 ;
