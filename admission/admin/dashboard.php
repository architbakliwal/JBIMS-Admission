		...
		<div class="wrapper">
	        ...
	        <div class="header dashboard_header">
			    <div class="grid-container">
                    ...
                    <div class="column-nine" style="text-align: left;">
					...
					<div class="column-two">
						<a href="<?php echo $baseurl;?>admin/password_update.php?lang=<?php echo $_GET['lang'];?>"><?php echo $lang['dashboard_update_your_password'];?></a>
					</div>
			...
			<div class="section">
				<div class="grid-container">
					...
					<div class="sky-tabs sky-tabs-pos-top-center sky-tabs-response-to-icons">
						...
						<input type="radio" name="sky-tabs" id="sky-tab9" class="sky-tab-content-8">
