<?php
	...
	if ($mysql == true){
		$sqltestgre = "INSERT INTO `jbims_admission`.`users_gre_score_details` (`application_id`, `gre_registration_number`, `gre_exam_date`, `gre_verbal_score`, `gre_quant_score`, `gre_total_score`, `gre_verbal_percentile`, `gre_quant_percentile`, `gre_total_percentile`, `gre_awa_awaited`, `gre_awa_score`, `gre_awa_percentile`) VALUES (
