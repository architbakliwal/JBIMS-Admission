...
if ( !CSRF::check( 'update-account-form' ) ) {
	...
	$update1 = "UPDATE ".$mysqltable_name_1." SET f_name = '".mysql_real_escape_string( $update_finalfirstname )."', l_name = '".mysql_real_escape_string( $update_finallastname )."' WHERE login_system_registrations_user_id = '".mysql_real_escape_string( $_SESSION['userLogin'] )."'";
