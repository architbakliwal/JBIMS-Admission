<?php
	...
	if(!CSRF::check('update-password-form')){
		...
		$update = "UPDATE ".$mysqltable_name_1." SET password = '".mysql_real_escape_string($newpassword)."', salt = '".mysql_real_escape_string($finalsalt)."' WHERE login_system_registrations_user_id = '".mysql_real_escape_string($_SESSION['userLogin'])."'";
