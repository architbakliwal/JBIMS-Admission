<?php
	...
	if ($mysql == true){
		...
		for ($x=1; $x<=$finalextraworkexcount; $x++) {
			...
			$sqlworkexextra = "INSERT INTO `jbims_admission`.`added_work_experience_details` (`application_id`, `work_experience`, `name_of_organization`, `organization_type`, `organization_type_other`, `industry_type`, `started_work_date`, `completed_work_date`, `joined_as`, `current_designation`, `annual_renumeration`, `roles_and_responsibilty`) VALUES (
				'".mysql_real_escape_string($finalapplicationid)."',
