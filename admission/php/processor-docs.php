...
if ( $mysql == true ) {
	...
	$sqltestgmat = "INSERT INTO `jbims_admission`.`users_documents_uploads` (`application_id`, `passport_photo`, `how_did_you_hear_of_jbims`, `applied_to_jbims_before`, `applied_to_jbims_before_year`, `other_support_information`) VALUES (
