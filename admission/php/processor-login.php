<?php
	...
	if(!CSRF::check('login-form')){
		...
		$userInfo = mysql_query("SELECT login_system_registrations_user_id, application_id, password, salt FROM ".$mysqltable_name_1." WHERE application_id = '".mysql_real_escape_string($finalusername)."'");
