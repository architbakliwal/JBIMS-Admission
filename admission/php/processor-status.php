...
if ( $mysql == true ) {
	$sqlstatus = "INSERT INTO `jbims_admission`.`admission_section_status` (`application_id`, `personal_details_status`, `contact_details_status`, `academic_details_status`, `work_ex_details_status`, `reference_details_status`, `score_details_status`, `document_details_status`) VALUES (
			'".$applicationid."',
			'".$personalstatus."',
			'".$contactstatus."',
			'".$academicestatus."',
