...
if(!isset($_SESSION)){
	...
	if(!$_SESSION['userLogin'] && !$_SESSION['userName']){
		...
		redirect('http://jbims.edu/admission/login.php');
	...
	if ($mysql == true){
		...
		$sqlpersonal = "SELECT f_name, l_name, category FROM  `users_personal_details` WHERE application_id ='" . $applicationid ."'";
...
$oMerchant->setMerchantDetails("00014225","00014225","00014225","193.545.34.33",rand()."","Ord123","http://jbims.edu/admission/payment/SFAResponse.php","POST","INR","INV123","req.Sale",$applicationfees,"","Ext1","true","Ext3","Ext4","Ext5");
