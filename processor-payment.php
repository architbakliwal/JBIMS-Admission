<?php
	...
	if ($mysql == true){
		$sqlpayment = "INSERT INTO `jbims_admission`.`users_payment_details` (`application_id`, `payment_mode`, `dd_payment_mode`, `dd_reference_number`, `dd_email_address`, `dd_bank_name`, `dd_date`, `payment_amount`, `payment_status`) VALUES (
